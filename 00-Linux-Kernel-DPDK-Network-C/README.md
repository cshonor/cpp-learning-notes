...
> 学习 C 的目的：读懂并编写 **Linux 内核**、**DPDK**、**Linux 网络服务** 相关代码。共 **00 导读 + 5 本书**（`00`、`01–05`）。  
> **HFT / 低延迟**：从 **[00 · HFT 学习路线](./00-hft-learning-path/)** 开始，不必等 C++ 01–10。

## 入口

| 目录 | 说明 |
|------|------|
| **[00-hft-learning-path](./00-hft-learning-path/)** | **从这里开始** — 路线、环境、01→05 过关标准 |
| [01–05 书单](#书单) | 五本 C 教材笔记与 demo |
...
- [ ] [00 HFT 学习路线](./00-hft-learning-path/)
- [ ] 01 K&R
- [ ] 02 C 和指针
- [ ] 03 C 陷阱与缺陷
- [ ] 04 C 专家编程
